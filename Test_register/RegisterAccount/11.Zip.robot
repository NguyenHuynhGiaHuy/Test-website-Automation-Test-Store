...
*** Test Cases ***
Register with the Zip having no characters (empty) and check the constraint: [Documentation] Đăng ký với trường Zip không có ký tự nào (rỗng) và kiểm tra ràng buộc:
...
Register with the Zip/postal code field achieving min and max length: and check the constraint

    [Documentation]    Đăng kí với trường Zip/postal code đạt độ dài tối thiểu và tối đa:và kiểm tra ràng buộc
...
Register with the Zip/postal code field shorter than 3 characters: and check the constraint
    [Documentation]    Đăng kí với trường Zip/postal code ngắn hơn 3 ký tự:và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Zip/postal code field longer than 10 characters: and check the constraint (bug có thể nhiều hơn 10 kí tự)


    [Documentation]    Đăng kí với trường Zip/postal code dài hơn 10 ký tự: và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Zip/postal code field containing only alphabetic characters: and check the constraint


    [Documentation]   Đăng kí với trường  Zip/postal code chỉ chứa ký tự chữ cái: và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Đăng kí với trường Zip/postal code chỉ chứa ký tự đặc biệt: và kiểm tra ràng buộc(bug: hơn cũng được luôn)
    [Documentation]    Đăng kí với trường Zip/postal code chỉ chứa ký tự đặc biệt: và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Zip/postal code field containing only special characters: and check the constraint
    [Documentation]    Đăng kí với trường Zip/postal code chỉ chứa ký tự đặc biệt: và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Zip/postal code field with a combination of letters, numbers and special characters, full length: and check the constraint

    [Documentation]    Đăng kí với trường Zip/postal code có kết hợp ký tự chữ cái, số và ký tự đặc biệt, đủ độ dài: và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Zip/postal code field exactly 3 characters long: and check the constraint

    [Documentation]   Đăng kí với trường  Zip/postal code có độ dài chính xác 3 ký tự: và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
