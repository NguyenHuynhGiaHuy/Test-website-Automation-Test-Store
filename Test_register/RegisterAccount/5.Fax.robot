...
*** Test Cases ***
Register with the Fax having no characters (empty) and check the constraint: [Documentation] Đăng ký với trường Fax không có ký tự nào (rỗng) và kiểm tra ràng buộc:
...
Register with the Fax field reaching min and max length: and check the constraint
    [Documentation]    Đăng kí với trường Fax đạt độ dài tối thiểu và tối đa:và kiểm tra ràng buộc
...
Register with the Fax field shorter than the minimum length: and check the constraint
    [Documentation]    Đăng kí với trường Fax ngắn hơn độ dài tối thiểu:và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Fax field longer than the maximum length: and check the constraint
    [Documentation]    Đăng kí với trường Fax dài hơn độ dài tối đa:và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Fax field containing non-numeric characters: and check the constraint
    [Documentation]    Đăng kí với trường Fax chứa ký tự không phải số:và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Fax field containing only numeric and special characters: and check the constraint
    [Documentation]    Đăng kí với trường Fax chỉ chứa ký tự số và ký tự đặc biệt:và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Fax field containing invalid special characters: and check the constraint
    [Documentation]    Đăng kí với trường Fax có chứa ký tự đặc biệt không hợp lệ:và kiểm tra ràng buộc
...
Register with the Fax field exactly 10 characters in length: and check the constraint
    [Documentation]    Đăng kí với trường Fax có độ dài chính xác 10 ký tự:và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
Register with the Fax field being exactly 3 characters long: and check the constraint
    [Documentation]    Đăng kí với trường Fax có độ dài chính xác 3 ký tự:và kiểm tra ràng buộc
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
